...
def irbi_rag(path='/home/mmartineau/sets/irbi/data.hdf5'):
    """Loads the IRBI RAG dataset.
    # Returns
        Tuple of Numpy arrays: `(feat_train, adj_train, y_train), (feat_valid, adj_valid, y_valid), (feat_test, adj_test, y_test)`.
    """
    
    f = h5py.File(path, 'r')
    feat_train, adj_train, y_train = f['train/feat'].value, f['train/adj'].value, f['train/y'].value
    feat_valid, adj_valid, y_valid = f['valid/feat'].value, f['valid/adj'].value, f['valid/y'].value
    feat_test, adj_test, y_test = f['test/feat'].value, f['test/adj'].value, f['test/y'].value
    f.close()
    return (feat_train, adj_train, y_train), (feat_valid, adj_valid, y_valid), (feat_test, adj_test, y_test)

def irbi_rag_crop(path='/home/mmartineau/sets/irbi/data_crop.hdf5'):
    """Loads the IRBI RAG crop dataset.
    # Returns
        Tuple of Numpy arrays: `(feat_train, adj_train, y_train), (feat_valid, adj_valid, y_valid), (feat_test, adj_test, y_test)`.
    """
...
def imagenet_rag_crop(path='/home/mmartineau/sets/imagenet/data_crop.hdf5'):
    """Loads the ImageNet-arthropods RAG crop dataset.
    # Returns
        Tuple of Numpy arrays: `(feat_train, adj_train, y_train), (feat_valid, adj_valid, y_valid), (feat_test, adj_test, y_test)`.
    """
